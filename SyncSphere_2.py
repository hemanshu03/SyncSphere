...
def refresh_captcha(): #This function creates a new captcha image and passes it to the client using XHR Requests.
    ...
    session_user_dets[session_id] = {'captcha_text':captcha_text}
...
def login(): #This function renders the login webpage.
    ...
    session_user_dets[key] = {'captcha_image': cptch.get_captcha_image()[0], 'captcha_text': cptch.get_captcha_image()[1]}
    #session_user_dets[key] = {'captcha_text':cptch_txt}
    return render_template('login.html', captcha_image=session_user_dets[key]['captcha_image'], session_id=key) 
...
def register__(): #This function renders the registration webpage (not yet ready).
    ...
    session_user_dets[key] = {'captcha_image': cptch.get_captcha_image()[0], 'captcha_text': cptch.get_captcha_image()[1]}
    #session_user_dets[key] = {'captcha_text':cptch_txt}
    return render_template('create.html', captcha_image=session_user_dets[key]['captcha_image'])
